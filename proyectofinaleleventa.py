...
def abrir_reportes():
    ...
    # TAMAÑO COLUMNAS
    tabla.column("producto", width=320, anchor="center")
...
# -------------------------
    ...
    # -------------------------
    # TEXTO TOTAL DE VENTAS
    # -------------------------
    lbl_texto_total = tk.Label(
        frame_total,
    ...
    btn_total = tk.Button(
        ...
        command=lambda: messagebox.showinfo(
            "Total de Ventas",
            f"El total acumulado de ventas es:\n\n${total_ventas:.2f}"
        )
    )
